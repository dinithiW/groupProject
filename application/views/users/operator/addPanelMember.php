	...
	<div class="w3-main" style="margin-left:250px">
        <div class="w3-row w3-padding-64" >
         ...
         <div class = "container" style="background-color: #548795;width: auto; border-color: black; padding-right: 10px;display: inline-block; margin-left: 20px; border-radius: 5px;padding-top: 10px; padding-bottom: 10px;">
                ...
                <form action = <?= base_url("OperatorIndex/delete")?> method = "POST" >
                <label for='email'>Panel ID</label>
                <input type='text' name='pIDDelete' id='email' required size='25'placeholder=" Enter the Panel ID" />
                <br/>

                <input type="submit" name="" value = "Delete Member" class="btn btn-primary btn-md" style="margin-right: auto;margin-left: 50px; ">
