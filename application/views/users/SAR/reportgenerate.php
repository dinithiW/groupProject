            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <script type="text/javascript"
                            src="<?= base_url('assets/plugin/tinymce/tinymce.min.js') ?>"></script>
                    <script type="text/javascript"
                            src="<?= base_url('assets/plugin/tinymce/init-tinymce.js') ?>"></script>

                    <form action="<?= base_url("sendmail") ?>" method="post">
                    <textarea class="tinymce" name="reportdetails"></textarea>
                        <br>
                        Mail Address :
                        <input type="text" name="directormail">
                        <input type="submit" name="haha" value="Send to Director" class="btn btn-primary btn-md"
                               style="float: right">
                    </form>
