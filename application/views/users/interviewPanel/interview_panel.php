                ...
                <div class="box">
                    ...
                    <div>
                        <table id="tblCommentsGiven"
                            ...
                            <tbody id="tblCommentsBody"></tbody>
                        </table>
                    </div>
                    ...
                    <div class="">
                        ...
                        <hr>
                        <form action="<?= base_url('InterviewPanelDashboard/submitApplicantMarks') ?>" method="post">
...
<script src="<?= base_url('application/views/users/interviewPanel/applicantController.js') ?>"></script>
<script>
    function getMarksAndComments(aid, dropdownName) {
        $.ajax(
            {

             type: "post",
                url: "<?= base_url('InterviewPanelDashboard/getMarks') ?>",
                data: {aid: aid, dropdownName: dropdownName},
                success: function (response) {
                    $('#tblMarksBody').html('');
                    $('#tblMarksBody').append(response);
                }
                // error: function () {
                //     alert("Invalide!");
                // }
        ...
        $.ajax(
            {
                type: "post",
                url: "<?= base_url('InterviewPanelDashboard/getComments') ?>",
                data: {aid: aid, dropdownName: dropdownName},
                success: function (response) {
                    $('#tblCommentsBody').html('');
                    $('#tblCommentsBody').append(response);
                }
                // error: function () {
                //     alert("Invalide!");
                // }
