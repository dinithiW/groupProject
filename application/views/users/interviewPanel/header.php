...
<!-- replacement for this given below https://www.w3schools.com/w3css/4/w3.css -->
<link rel="stylesheet" href="<?=base_url('assets/css/commonw.css')?>">
...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-green" href="<?= base_url('OperatorDashboard/categorizeApplications') ?>">View Applicant Marks</a>
