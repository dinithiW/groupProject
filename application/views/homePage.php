      ...
      <div class="row">
          ...
          <div class="pm-staff-profile-container">
            <div class="pm-staff-profile-image-wrapper text-center">
              <div class="pm-staff-profile-image">
                <img src="<?php echo base_url('assets/images/director.jpg');?>" alt="" class="img-thumbnail img-circle" />
              </div>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            <div class="pm-staff-profile-image-wrapper text-center">
              <div class="pm-staff-profile-image">
                <img src="<?= base_url('assets/images/aja.jpg')?>" alt="" class="img-thumbnail img-circle" />
              </div>
            </div>
            <div class="pm-staff-profile-details text-center">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            <div class="pm-staff-profile-image-wrapper text-center">
              <div class="pm-staff-profile-image">
                <img src="<?= base_url('assets/images/arw.jpg')?>" alt="" class="img-thumbnail img-circle" />
              </div>
            </div>
            <div class="pm-staff-profile-details text-center">
           ...
           <div class="fea">
              ...
              <div class="heading pull-right">
				<p class="small-text" style="color:black;text-align:center" ><b>Our Vision:</b></p> 
				 <p>To advance and enhance computing knowledge, fostering global strategic alliances, promoting cross disciplinary research, producing socially responsible professionals with entrepreneurial skills, leadership.</p>
				</div>
				</div>
				</div>
        </div>
